            ...
            <div class="mainbox" id="login-main">
              ...
              <div class="nav_tabs_panel">
                <div id="nav-tabs" class="nav_tabs">
                  <a class="navtab-link now" href="javascript:void(0);" data-tab="pwd">小米帐号登录</a><!-- <span class="line"></span>  -->
                  <!-- <a class="navtab-link" href="javascript:void(0);" data-tab="qr" id="open">扫码登录</a> -->
