                ...
                <div class="uc-box uc-sub-box">
                    ...
                    <div class="uc-nav-box">
                        ...
                        <div class="box-bd">
                            <ul class="uc-nav-list">
                                <li>
                                    <a href="{{ asset('home2/pinfo') }}" >我的个人中心</a>
                                </li>
                                <li>
                                    <a href="/home2/cullect" >喜欢的商品</a></li>
                               
                                <li>
                                    <a href="/home2/address" >收货地址</a></li>
                            </ul>
                        </div>
                    </div>
    ...
    form.submit();
            ...
            <div class="box-bd">
                ...
                <div id="editAddr" class="order-detail-info">
                    ...
                    <div class="actions">
                        <a class="btn btn-small btn-line-gray J_editAddr" href="/home2/address" >修改</a>
                    </div> 
