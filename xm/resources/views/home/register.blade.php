...
<div class="wrap">
  ...
  <div class="n-frame device-frame reg_frame">
    ...
    <form method="post" action='/home1/doregister'>
    {{ csrf_field() }}
    ...
    <div class="regbox">
      ...
      <div class="inputbg">
        ...
        <label class="labelbox labelbox-user" for="user">
          <input name="User_name" id="user" autocomplete="off" placeholder="注册的用户名：2-8位" rule="" type="text">
         </label>
      ...
      <div class="inputbg">
        <!-- 错误添加class为err_label -->
        <label class="labelbox labelbox-user" for="user">
          <input name="User_email" id="user" autocomplete="off" placeholder="邮箱" rule="" type="text">
         </label>
      ...
      <div class="inputbg">
        <!-- 错误添加class为err_label -->
        <label class="labelbox labelbox-user" for="user">
          <input name="User_pwd" id="user" autocomplete="off" placeholder="设置密码：最少6位" rule="" type="password">
         </label>
      </div>  
      <div class="inputbg">
        <!-- 错误添加class为err_label -->
        <label class="labelbox labelbox-user" for="user">
          <input name="User_pwdd" id="user" autocomplete="off" placeholder="确认密码" rule="" type="password">
         </label>
      </div>  
          ...
          <span id="error-content"></span>
			...
			<div class="inputbg inputcode dis_box">
				<label class="labelbox labelbox-captcha" for="">
					<input id="code-captcha" class="code" name="User_mycode" placeholder="图片验证码" type="text">
				</label>
      ...
      <div class="fixed_bot">
        <input class="btn332 btn_reg_1" id="submit_button" value="立即注册" type="submit">   
      </div>
