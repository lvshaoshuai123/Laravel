...
<script type="text/javascript" async="" src="{{asset('home/list/js/unjcV2.js')}}"></script><script type="text/javascript" async="" src="{{asset('home/list/js/mstr.js')}}"></script><script type="text/javascript" async="" src="{{asset('home/list/js/jquery.js')}}"></script><script type="text/javascript" async="" src="{{asset('home/list/js/xmst.js')}}"></script>
...
<div class="site-header">
    <div class="container">
        <div class="header-logo">
            <a href="/home1"><img src="{{ asset('admin/upload').'/'.'s_'.$net->Net_logo }}" alt=""></a>
                    </div>
...
<div class="page-main channel buyphone-channel">
    <div class="container breadcrumbs"> 
        <a href="/home1">首页</a><span class="sep">/</span>选购
    </div>  
    <div class="container channel-nav">
    <ul class="clearfix">
        <li class="current">
            <a data-stat-id="37221d8e391cd561" onclick="_msq.push(['trackEvent', '8076ed7ffc35f6db-37221d8e391cd561', '', 'pcpid', '']);">选购</a>
        </li>
