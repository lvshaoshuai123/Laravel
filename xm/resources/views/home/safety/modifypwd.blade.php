...
<div class="wrap">
  ...
  <div class="n-frame device-frame reg_frame">
    ...
    <form action="/home2/domodify" method="post" id="forgetpwd_form">
    {{ csrf_field() }}
    <!-- <input name="qs" value="" type="hidden"> -->
    <input type="hidden" name='User_id' value="{{ $id }}">
    <!-- 记得在此添加标记语言uLocale -->
    <div class="regbox">
      <!-- <h5 class="n_tit_msg" align='center'>请输入原始密码：</h5>       -->
      <h4>原始密码</h4>
      <div class="inputbg">
        <!-- 错误添加class为err_label -->
        <label class="labelbox labelbox-user" for="user">
          <input name="User_pwd" id="user" autocomplete="off" placeholder="原密码" rule="" type="password">
         </label>
      ...
      <div class="inputbg">
        <!-- 错误添加class为err_label -->
        <label class="labelbox labelbox-user" for="user">
          <input name="User_pwdd" id="user" autocomplete="off" placeholder="新密码" rule="" type="password">
         </label>
      ...
      <div class="inputbg">
        <!-- 错误添加class为err_label -->
        <label class="labelbox labelbox-user" for="user">
          <input name="User_pwddd" id="user" autocomplete="off" placeholder="确认新密码" rule="" type="password">
         </label>
