...
<div class="wrap">
  ...
  <div class="n-frame device-frame reg_frame">
    ...
    <!-- 记得在此添加标记语言uLocale -->
    <div class="regbox">
      <h5 class="n_tit_msg">请输入注册的邮箱地址、手机号码和小米用户名：</h5>      
      <div class="inputbg">
        <!-- 错误添加class为err_label -->
        <label class="labelbox labelbox-user" for="user">
          <input name="User_name" id="user" autocomplete="off" placeholder="注册的用户名" rule="(^[\w.\-]+@(?:[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*\.)+[A-Za-z]{2,6}$)|(^1\d{10}$)|(^\d{3,}$)|(^\++\d{2,}$)" type="text">
         </label>
      ...
      <div class="inputbg">
        <!-- 错误添加class为err_label -->
        <label class="labelbox labelbox-user" for="user">
          <input name="User_email" id="user" autocomplete="off" placeholder="用户名绑定的邮箱" rule="(^[\w.\-]+@(?:[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*\.)+[A-Za-z]{2,6}$)|(^1\d{10}$)|(^\d{3,}$)|(^\++\d{2,}$)" type="text">
         </label>
      ...
      <div class="inputbg">
        <!-- 错误添加class为err_label -->
        <label class="labelbox labelbox-user" for="user">
          <input name="User_tel" id="user" autocomplete="off" placeholder="用户名绑定的手机号" rule="(^[\w.\-]+@(?:[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*\.)+[A-Za-z]{2,6}$)|(^1\d{10}$)|(^\d{3,}$)|(^\++\d{2,}$)" type="text">
         </label>
          ...
          <span id="error-content"></span>
			...
			<!-- <div class="inputbg inputcode dis_box">
				<label class="labelbox labelbox-captcha" for="">
					<input id="code-captcha" class="code" name="icode" placeholder="图片验证码" type="text">
				</label>
      ...
      <div class="fixed_bot">
        <input class="btn332 btn_reg_1" id="submit_button" value="提交验证信息" type="submit">   
      </div>
    </div>
    </form>        
  </div>
