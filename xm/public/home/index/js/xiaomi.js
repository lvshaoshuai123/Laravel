...
$("#head_car").hover(function(){
    ...
    $("#car_content").css({"width":"300px","display":"block"}).animate({
        height:"100px"
    },400).finish();
},function(){
    $(this).css("background", "#424242");
    $(".head_car_text").css("color", "#b0b0b0");
    $("#car_content").css({"width":"300px","display":"none"}).animate({
        height:"0px"
    },400);
})
//导航栏控制显示

$(".more_span").hover(function(){
...
$(".floor_goods_wrap_li_a").hover(function () {
       $(this).css({"top":"-5px",
           "box-shadow":"0px 15px 30px rgba(0,0,0,0.2)"
       });
},function(){
...
$(".foot_note_txt").children("a").hover(function(){
    $(this).css("color","#ff6700");
},function(){
   $(this).css("color"," #424242");
})
...
$(".banner_menu_content_ul_a").hover(function(){
    $(this).attr("style","color:#ff6700");
},function(){
   $(this).attr("style","color:#424242");
})